    ...
    <section id="contacto" style={{ padding: "100px 0", background: "var(--surface)" }}>
      <div className="container">
        ...
        >
            ...
            <div style={{ marginTop: "2.5rem", display: "flex", flexDirection: "column", gap: "1rem" }}>
              {[
                ...
                >
                  ...
                  <span style={{ fontSize: "0.9rem", color: "var(--text)", marginTop: "0.2rem" }}>
                    {item.value}
                  </span>
                </div>
              ))}
          ...
          >
            <h3 style={{ fontFamily: "var(--font-display)", fontSize: "1.75rem", fontWeight: 300, marginBottom: "1.5rem" }}>
              Consulta rápida
            </h3>
            ...
            {status === "success" ? (
              <div style={{ textAlign: "center", padding: "2rem 0" }}>
                ...
                <div style={{ color: "var(--gold)", fontWeight: 500, marginBottom: "0.5rem" }}>¡Contacto registrado!</div>
                <div style={{ fontSize: "0.875rem", color: "var(--text-muted)" }}>{message}</div>
                <button onClick={() => setStatus(null)} className="btn-outline" style={{ marginTop: "1.5rem" }}>
                  Registrar otro
                </button>
              </div>
            ) : (
              <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                ...
                >
                  {status === "loading" ? "Registrando…" : "Registrar contacto"}
                </button>
              </div>
            )}
          </div>
